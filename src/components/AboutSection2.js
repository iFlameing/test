            ...
            <div className="row align-items-center mt-5">
              <Col md="6">
                <div className="about-desc">
                  <h3 className="text-white mb-3 font-weight-light">
                    Performancect Solution For Small Businesses
                  </h3>
                  <p className="text-white-50 f-15">
                    Temporibus autem quibusdam a aut officiis debitis rerum
                    necessitatibus saepeeveniet ut et voluptates repudiandae
                    sint a molestiae recusandae itaque earum rerum hic tenetur a
                  ...
                  <div className="about-by">
                    <p className="font-weight-light mb-0">
                      <Link to="#" className="text-white">
                        <i className="mdi mdi-circle-medium text-custom mr-2"></i>
                        Learn More{" "}
                        <span className="text-custom"> About Us</span>
                      </Link>
                    </p>
                  </div>
                </div>
